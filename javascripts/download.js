function downloadURL() {
	var newfilename = prompt("Enter the file name!", filename);
	if (!newfilename) {
		return;
	}
	...
	var action = ""; // Includes addCounter, Equip, setTarget, etc.
	...
	for (var i = 0; i < fields.length; i++) {
		...
		for (var j = 0; j < thumbs.length; j++) {
			...
			if (location == "LOCATION_MZONE") { // The order of MZONE needs to be reversed
